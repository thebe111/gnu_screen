...
term[T_N] = {
    ...
    // == attributes ==
    // TODO: define T_ATTR
    // WARN: order is important for how we set up attributes
    { "mh", T_STR  },
    { "us", T_STR  },
    { "md", T_STR  },
    { "mr", T_STR  },
